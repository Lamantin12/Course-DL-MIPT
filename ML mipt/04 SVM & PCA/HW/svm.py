...
def rbf(x_1, x_2, sigma=1.):
    ...
    '''
    distances = torch.exp(-sigma * torch.matmul(x_1, x_2.T))
...
class SVM(BaseEstimator, ClassifierMixin):
    ...
    def fit(self, X, Y):
        ...
        for epoch in range(self.epochs):
            ...
            self.epoch_loss.append(sum_loss / self.batch_size)
    ...
    def predict_scores(self, batch):
        with torch.no_grad(): #blocks gradient for all tensors having it
